...
- rest:
    id: rest-1
      ...
      const initialCount = camelResource.getVisualEntities().length;
...
- rest:
    id: rest-1
      ...
      await waitFor(() => {
        expect(camelResource.getVisualEntities().length).toBe(initialCount + 1);
      });
...
- rest:
    id: rest-1
      ...
      await waitFor(() => {
        expect(camelResource.getVisualEntities().length).toBe(2);
      });
